  ...
  return (
    ...
    bg-accent rounded-[45px] p-[50px] md:p-[60px] relative">
      <div className="md:pr-[22rem]">
        ...
        Get in touch with us today to discover how Denteex can streamline your operations, boost patient satisfaction, and elevate your practice to the next level.
        </p>
